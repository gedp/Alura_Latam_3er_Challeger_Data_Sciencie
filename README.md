...
Impacto
⏱️ Duración del Contrato (meses)
18.34%
16.82%
🔴 Crítico
📋 Tipo de Contrato_Mes a mes
16.82%
14.57%
🔴 Crítico
💰 Costo Total
...
4.56%
🟡 Medio
📱 Método de Pago_Cheque electrónico
3.90%
3.74%
🟡 Medio
📋 Tipo de Contrato_Dos años
3.77%
3.45%
🟢 Bajo
...
📊 Distribución de Churn: Gráfico circular mostrando proporción de abandono.
...
Implementar análisis A/B para evaluar efectividad de estrategias.
...
📋 Copiar el código: Copiar todo el código del archivo TelecomX_Churn_Prediction.ipynb
...
git clone https://github.com/tu-usuario/challenge3-data-science-alura-latam.git
